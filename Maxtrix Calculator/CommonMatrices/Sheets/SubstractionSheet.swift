...
struct SubstractionSheet: View {
    ...
    var body: some View {
        ...
        VStack{
            Text("The difference is computed by subtracting corresponding elements of A and B").font(.title2).multilineTextAlignment(.center).padding(.bottom).foregroundColor(Color(Data.ColorText))
            VStack{
...
struct SubstractionSheet_Previews: PreviewProvider {

//
//  SubstractionModularSheet.swift
//  Maxtrix Calculator
//
...
struct SubstractionModularSheet: View {
    ...
    var body: some View {
        ...
        VStack{
            Text("The difference is computed by subtracting corresponding elements of A and B. Then finding the remainder of result divided by modulo ").font(.title2).multilineTextAlignment(.center).padding(.bottom).foregroundColor(Color(Data.ColorText))
            VStack{
...
struct SubstractionModularSheet_Previews: PreviewProvider {
